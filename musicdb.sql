...
ALTER TABLE public.favourite_favourite_id_seq OWNER TO postgres;

--
-- Name: favourite_favourite_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
CREATE TABLE public.genre (
    ...
    subgenre character varying(45) NOT NULL
);
...
CREATE TABLE public.music (
    ...
    genre_id bigint,
    album_id bigint,
    music_url character varying(100) NOT NULL,
    awards character varying(1000),
    artist_id bigint NOT NULL,
...
--
-- Name: music_score_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.music_score_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.music_score_id_seq OWNER TO postgres;

--
-- Name: music_score_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.music_score_id_seq OWNED BY public.music.score_id;
...
--
-- Name: tags_in_music; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.tags_in_music (
    music_id integer NOT NULL,
    tag_id integer NOT NULL
);


ALTER TABLE public.tags_in_music OWNER TO postgres;
...
--
-- Name: favourite favourite_id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: music score_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.music ALTER COLUMN score_id SET DEFAULT nextval('public.music_score_id_seq'::regclass);
...
COPY public.favourite (favourite_id, playlist_id, music_id) FROM stdin;
1	13	2
2	3	4
3	4	1
4	14	11
...
COPY public.genre (genre_id, genre, subgenre) FROM stdin;
1	metal	heavy_metal
2	metal	trash_metal
3	metal	death_metal
4	folk	folk_metal
5	folk	folk_rock
6	country	country_blues
7	country	country_rap
8	country	country_soul
9	electro	electro_hop
10	electro	electro_house
11	rock	christian_rock
12	rock	instrumental_rock
13	rock	rock_and_roll
14	electro	electro_rock
15	synthwave	ekectro_swing
\.
...
COPY public.music (music_id, "time", genre_id, album_id, music_url, awards, artist_id, score_id) FROM stdin;
2	04:11:00	1	1	https://www.youtube.com/watch?v=dQw4w9WgXcQ	Grammy	1	12
7	03:45:00	3	5	https://www.youtube.com/watch?v=6mhmcwmgWbA	Teen_Choice_Award	1	9
34	01:23:00	5	2	https://www.youtube.com/watch?v=AyOqGRjVtls	NEA	2	4
39	02:32:00	3	2	https://www.youtube.com/watch?v=rAx5LIul1N8	Eksa_Music_Award	1	13
40	04:32:00	7	1	https://www.youtube.com/watch?v=sO4wVSA9UPs	Superjedynki	5	11
48	04:32:00	4	2	https://www.youtube.com/watch?v=ptw2FLKXDQE	MTV_Video_Music_Award	5	14
53	02:11:00	5	3	https://www.youtube.com/watch?v=oHg5SJYRHA0	Złote_Dzioby	1	14
55	02:02:00	2	1	https://www.youtube.com/watch?v=7z_1E8VGJOw	Adult_Choice_Award	2	6
57	03:07:00	6	2	https://www.youtube.com/watch?v=5wOXc03RwVA	Eksa_Music_Award	4	4
59	04:03:00	5	4	https://www.youtube.com/watch?v=Gc2u6AFImn8	Fryderyk	4	8
\.
...
--
-- Data for Name: tags_in_music; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.tags_in_music (music_id, tag_id) FROM stdin;
1	1
2	1
3	3
4	3
...
SELECT pg_catalog.setval('public.favourite_favourite_id_seq', 15, true);
...
SELECT pg_catalog.setval('public.genre_genre_id_seq', 15, true);
...
SELECT pg_catalog.setval('public.music_music_id_seq', 59, true);


--
-- Name: music_score_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.music_score_id_seq', 1, false);
...
--
-- Name: genre genre_subgenre_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.genre
    ADD CONSTRAINT genre_subgenre_key UNIQUE (subgenre);


--
-- Name: music music_music_url_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.music
    ADD CONSTRAINT music_music_url_key UNIQUE (music_url);
...
--
-- Name: music music_album_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.music
    ADD CONSTRAINT music_album_id_fkey FOREIGN KEY (album_id) REFERENCES public.album(album_id);


--
-- Name: music music_artist_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.music
    ADD CONSTRAINT music_artist_id_fkey FOREIGN KEY (artist_id) REFERENCES public.artist(artist_id);


--
-- Name: music music_genre_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.music
    ADD CONSTRAINT music_genre_id_fkey FOREIGN KEY (genre_id) REFERENCES public.genre(genre_id);


--
-- Name: music music_score_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.music
    ADD CONSTRAINT music_score_id_fkey FOREIGN KEY (score_id) REFERENCES public.score(score_id);
